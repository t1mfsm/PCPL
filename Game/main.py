...
bg1 = pygame.image.load('Game\\Assets\\background-day.png')
bg2 = pygame.image.load('Game\\Assets\\background-night.png')

bg = random.choice([bg1, bg2])

im_list = [pygame.image.load('Game\\Assets\\pipe-green.png'), pygame.image.load('Game\\Assets\\pipe-red.png')]
pipe_img = random.choice(im_list)

gameover_img =  pygame.image.load('Game\\Assets\\gameover.png')
flappybird_img =  pygame.image.load('Game\\Assets\\flappybird.png')
flappybird_img = pygame.transform.scale(flappybird_img, (200,80))

# Sounds & fx


die_fx = pygame.mixer.Sound('Game\\Sounds\\die.wav')
hit_fx = pygame.mixer.Sound('Game\\Sounds\\hit.wav')
point_fx = pygame.mixer.Sound('Game\\Sounds\\point.wav')
swoosh_fx = pygame.mixer.Sound('Game\\Sounds\\swoosh.wav')
wing_fx = pygame.mixer.Sound('Game\\Sounds\\wing.wav')
